...
#include "drover4_info_interface/msg/detail/d_rover4_info__rosidl_typesupport_fastrtps_c.h"
...
#include "drover4_info_interface/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_drover4_info_interface
...
using _DRover4Info__ros_msg_type = drover4_info_interface__msg__DRover4Info;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _DRover4Info__ros_msg_type * ros_message = static_cast<const _DRover4Info__ros_msg_type *>(untyped_ros_message);
  // Field name: rover_id
  {
  ...
  void * untyped_ros_message)
{
  ...
  _DRover4Info__ros_msg_type * ros_message = static_cast<_DRover4Info__ros_msg_type *>(untyped_ros_message);
  // Field name: rover_id
  {
    cdr >> ros_message->rover_id;
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_drover4_info_interface
size_t get_serialized_size_drover4_info_interface__msg__DRover4Info(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _DRover4Info__ros_msg_type * ros_message = static_cast<const _DRover4Info__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _DRover4Info__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_drover4_info_interface__msg__DRover4Info(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_drover4_info_interface
size_t max_serialized_size_drover4_info_interface__msg__DRover4Info(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = drover4_info_interface__msg__DRover4Info;
    is_plain =
      (
...
static size_t _DRover4Info__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_drover4_info_interface__msg__DRover4Info(
...
static message_type_support_callbacks_t __callbacks_DRover4Info = {
...
static rosidl_message_type_support_t _DRover4Info__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_DRover4Info,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, drover4_info_interface, msg, DRover4Info)() {
  return &_DRover4Info__type_support;
}
