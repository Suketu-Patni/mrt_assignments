...
#include "interfaces/srv/detail/path__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces::srv::Path_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::srv::Path_Request & ros_message)
{
  // Member: bounding_boxes
  {
    cdr >> ros_message.bounding_boxes;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces::srv::Path_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces::srv::Path_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::srv::Path_Request *>(
    untyped_ros_message);
...
{
  return &interfaces::srv::typesupport_fastrtps_cpp::_Path_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, srv, Path_Request)() {
  return &interfaces::srv::typesupport_fastrtps_cpp::_Path_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_interfaces
cdr_serialize(
  const interfaces::srv::Path_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: path
  {
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::srv::Path_Response & ros_message)
{
  // Member: path
  {
    cdr >> ros_message.path;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = interfaces::srv::Path_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces::srv::Path_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<interfaces::srv::Path_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &interfaces::srv::typesupport_fastrtps_cpp::_Path_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, srv, Path_Response)() {
  return &interfaces::srv::typesupport_fastrtps_cpp::_Path_Response__handle;
}
...
{
  return &interfaces::srv::typesupport_fastrtps_cpp::_Path__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, srv, Path)() {
  return &interfaces::srv::typesupport_fastrtps_cpp::_Path__handle;
}
