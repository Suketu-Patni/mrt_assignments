...
static const _BoundingBoxes_Request_type_support_symbol_names_t _BoundingBoxes_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, srv, BoundingBoxes_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces, srv, BoundingBoxes_Request)),
  }
};
...
{
  return &::interfaces::srv::rosidl_typesupport_cpp::BoundingBoxes_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, interfaces, srv, BoundingBoxes_Request)() {
  return get_message_type_support_handle<interfaces::srv::BoundingBoxes_Request>();
}
...
static const _BoundingBoxes_Response_type_support_symbol_names_t _BoundingBoxes_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, srv, BoundingBoxes_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces, srv, BoundingBoxes_Response)),
  }
};
...
{
  return &::interfaces::srv::rosidl_typesupport_cpp::BoundingBoxes_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, interfaces, srv, BoundingBoxes_Response)() {
  return get_message_type_support_handle<interfaces::srv::BoundingBoxes_Response>();
}
...
static const _BoundingBoxes_type_support_symbol_names_t _BoundingBoxes_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, srv, BoundingBoxes)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces, srv, BoundingBoxes)),
  }
};
...
{
  return &::interfaces::srv::rosidl_typesupport_cpp::BoundingBoxes_service_type_support_handle;
}
